    ...
    inputSchema: {
      ...
      properties: {
        ...
        sessionId: {
          type: 'string',
          description:
            'Optional session ID for conversational context. Note: when resuming a session, sandbox/fullAuto parameters are not applied (CLI limitation)',
        },
        resetSession: {
          type: 'boolean',
          description:
        ...
        model: {
          type: 'string',
          description:
            'Specify which model to use (defaults to gpt-5.4). Options: gpt-5.4, gpt-5.2-codex, gpt-5.1-codex, gpt-5.1-codex-max, gpt-5-codex, gpt-4o, gpt-4, o3, o4-mini',
        },
        reasoningEffort: {
          type: 'string',
          enum: ['minimal', 'low', 'medium', 'high', 'xhigh'],
          description:
            'Control reasoning depth (minimal < low < medium < high < xhigh). Defaults to xhigh',
        },
        sandbox: {
          type: 'string',
    ...
    inputSchema: {
      ...
      properties: {
        ...
        model: {
          type: 'string',
          description:
            'Specify which model to use for the review (defaults to gpt-5.4)',
        },
        workingDirectory: {
          type: 'string',
